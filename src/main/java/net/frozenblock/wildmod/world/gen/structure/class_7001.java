...
public class class_7001
        extends WildJigsawFeature {
    public static final int field_36900 = 128;

    public class_7001(Codec<StructurePoolFeatureConfig> codec) {
        super(codec, (structureManager, structurePoolElement, blockPos, i, blockRotation, blockBox) -> new class_7008(structureManager, structurePoolElement, blockPos, i, blockRotation, blockBox, WildMod.BEARD_AND_SHAVE), random -> -40, false, false, class_7001::method_40836, 128);
    }
